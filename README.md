...
Performance Features
    ...
    Smart Caching: Redundant API calls avoided

    Dynamic Formatting: Adapts to terminal width

    Graceful Degradation: Handles missing models/timeouts

Safety Features

    Timeouts: Prevent hanging (configurable)

    Error Handling: Continues if one model fails

    Resource Limits: Caps concurrent requests
...
Visual Design
    ...
    Color-coded models (each gets a unique color)
...
Intuitive slash commands:
    ...
    /chain, /debate, /ensemble - Collaboration

    /benchmark, /compare - Testing

    /export, /save - Data management

    /select, /list - Model selection
...
Feedback Loop
    ...
    Progress during parallel processing
...
The architecture supports:
    ...
    Web interface (add Flask/FastAPI)

    REST API (expose as service)

    Plugin system (custom collaboration modes)
...
Tiny Model Swarm transforms Ollama from a single-model runner into a multi-model collaboration platform. It's like having a team of AI experts at your command, all running locally on your machine, working together on your tasks, and providing diverse perspectives - all while maintaining complete privacy and control.
how to have all models debate /debate <topic> [models] [rounds] - Model debate
?
🎭 How to Use Model Debate in Tiny Model Swarm

The debate feature lets multiple AI models argue/discuss a topic over multiple rounds, responding to each other's arguments. Here's everything you need to know:
Basic Syntax
bash
...
Examples of Usage
1. Simple Debate (Auto-selects first 3 models)
bash

/debate "Should artificial intelligence be regulated?"

This will:

    Use first 3 available models (e.g., llama2, mistral, codellama)

    Default to 2 rounds of debate

    Save results to ~/.tiny-swarm-data/collaborations/

2. Specify Models
bash

/debate "Is free will real?" llama2,mistral,neural-chat

    Uses exactly these 3 models

    Still default 2 rounds

3. Specify Models and Rounds
bash

/debate "Python vs JavaScript for web development" codellama,deepseek-coder,mistral 3

    3 rounds of debate

    Coding-focused models debate programming languages

4. Specify Rounds Only
bash

/debate "Climate change solutions" 4

    4 rounds of debate

    Uses first 3 available models

What Happens During a Debate
Round 1: Opening Statements

Each model presents its initial position:
text

Round 1:
  llama2 thinking...
  mistral thinking...
  neural-chat thinking...

Round 2: Rebuttals

Models see each other's arguments and respond:
text

Round 2:
  llama2 thinking... (responding to mistral and neural-chat)
  mistral thinking... (addressing counter-arguments)
  neural-chat thinking... (building on previous points)

Round 3+: Deepening Discussion

Models refine positions and find common ground
Real Example Output
bash

> /debate "Should students use AI for homework?" 2

🎭 DEBATE COLLABORATION
Topic: Should students use AI for homework?
...
Round 1:
  llama2 thinking...
  ✓ Responded in 2.3s
    AI can be a valuable learning tool when used properly...
  
  mistral thinking...
  ✓ Responded in 1.8s
    Students must learn fundamentals first before using AI...
  
  neural-chat thinking...
  ✓ Responded in 2.1s
    AI should be treated like a calculator - a tool, not a crutch...

Round 2:
  llama2 thinking... (responding to others)
  ✓ Responded in 2.5s
    While mistral raises valid points about fundamentals...
  
  mistral thinking...
  ✓ Responded in 1.9s
    I appreciate neural-chat's calculator analogy, however...
  
  neural-chat thinking...
  ✓ Responded in 2.2s
    Building on both perspectives, perhaps a hybrid approach...

✅ Debate saved to /home/user/.tiny-swarm-data/collaborations/debate_20240315_143022.json
✅ Transcript saved to /home/user/.tiny-swarm-data/collaborations/debate_20240315_143022.txt

Best Practices
Choose Good Debate Topics
...
❌ Poor topics:
    ...
    "What is 2+2?" (too factual)

    Simple yes/no questions

    Topics requiring specific expertise

Select Appropriate Models
bash

# For technical debates
/debate "Best database for startups" codellama,mistral,llama2

# For philosophical debates  
/debate "Meaning of consciousness" neural-chat,llama2,mistral

# For creative debates
/debate "Future of art in AI age" dolphin,neural-chat,llama2

Adjust Rounds Based on Topic

    2 rounds: Simple topics, quick comparisons

    3 rounds: Most topics, allows for rebuttal and synthesis

    4+ rounds: Complex philosophical debates

Viewing Debate Results

After a debate, you get TWO files:
1. JSON File (for data analysis)
bash

cat ~/.tiny-swarm-data/collaborations/debate_20240315_143022.json
...
2. Transcript File (human-readable)
bash

cat ~/.tiny-swarm-data/collaborations/debate_20240315_143022.txt

text

DEBATE: Should students use AI for homework?
============================================================
...
Shows your 10 most recent collaborations:
text

📋 Saved Collaborations:
  • debate_20240315_143022.json (debate) - 2024-03-15 14:30
  • debate_20240315_141015.json (debate) - 2024-03-15 14:10
  • chain_20240315_135022.json (chain) - 2024-03-15 13:50

Tips for Better Debates
1. Set Timeout for Long Debates
bash

/timeout 60  # 60 seconds per response
/debate "Consciousness in AI" 4

2. Use Small Models for Speed
bash

/select-small  # Selects models under 2GB
/debate "Fast food ethics" 3

3. Mix Model Types
bash

# Get different perspectives
/debate "Cryptocurrency future" \
  codellama, \      # Technical perspective
  mistral, \        # Balanced view  
  dolphin           # Creative take

4. Save Interesting Debates
bash

# After debate, export in different formats
/export md     # Markdown for documentation
/export csv    # CSV for spreadsheet analysis

Troubleshooting
Problem: "Need at least 2 models"

Solution: Pull more models first
bash
...
Problem: Debates timing out

Solution: Increase timeout
bash

/timeout 120  # 2 minutes per response
/debate "Complex philosophical topic" 3

Problem: Models repeating themselves

Solution: Use fewer rounds or different models
bash

/debate "Your topic" llama2,mistral 2  # Only 2 rounds

Advanced: Using Debate Results
Export to Markdown for Documentation
bash

/export md
# Creates beautiful documentation of the debate

Analyze in Python
python

import json
with open('~/.tiny-swarm-data/collaborations/debate_*.json') as f:
    data = json.load(f)
    # Analyze response times, argument patterns, etc.

Create Summary
bash

# After debate, use ensemble to summarize
/ensemble "Summarize the key points from the debate about [topic]" summary

The debate feature turns your local models into a dynamic discussion panel - perfect for exploring complex topics, testing different perspectives, or just having fun watching AIs argue!
